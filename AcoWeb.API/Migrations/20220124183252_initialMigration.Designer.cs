...
namespace AcoWeb.API.Migrations
{
    ...
    [Migration("20220124183252_initialMigration")]
            ...
            modelBuilder.Entity("AcoWeb.API.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2017, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(178), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2020, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(205), new TimeSpan(0, 2, 0, 0, 0)),
                            OfficeId = new Guid("5ab77607-42e8-4a25-b47a-db8983a652e8"),
                        ...
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2020, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(210), new TimeSpan(0, 2, 0, 0, 0)),
                            OfficeId = new Guid("5ab77607-42e8-4a25-b47a-db8983a652e8"),
                        ...
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2020, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(213), new TimeSpan(0, 2, 0, 0, 0)),
                            OfficeId = new Guid("5ab77607-42e8-4a25-b47a-db8983a652e8"),
                        ...
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2020, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(215), new TimeSpan(0, 2, 0, 0, 0)),
                            OfficeId = new Guid("5ab77607-42e8-4a25-b47a-db8983a652e8"),
                        ...
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2020, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(219), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2020, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(221), new TimeSpan(0, 2, 0, 0, 0)),
                            OfficeId = new Guid("7c862b39-c6d1-4c91-8181-c6cc35890bca"),
                            RoleInCompany = "Sellman",
                            Salary = 400000m
                        },
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2020, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(224), new TimeSpan(0, 2, 0, 0, 0)),
                            OfficeId = new Guid("7c862b39-c6d1-4c91-8181-c6cc35890bca"),
                        ...
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2017, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(226), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2020, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(229), new TimeSpan(0, 2, 0, 0, 0)),
                            OfficeId = new Guid("ca2abc8e-1bdc-4887-8f97-215fe050f22f"),
                            RoleInCompany = "Backend developer",
                            Salary = 190000m
                        },
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2017, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(231), new TimeSpan(0, 2, 0, 0, 0)),
                            OfficeId = new Guid("ca2abc8e-1bdc-4887-8f97-215fe050f22f"),
                        ...
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2020, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(234), new TimeSpan(0, 2, 0, 0, 0)),
                        ...
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2020, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(236), new TimeSpan(0, 2, 0, 0, 0)),
                            OfficeId = new Guid("d097a599-4619-4473-ae86-d353c3069597"),
                            RoleInCompany = "Credit officer",
                            Salary = 250000m
                        },
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2020, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(239), new TimeSpan(0, 2, 0, 0, 0)),
                            OfficeId = new Guid("d097a599-4619-4473-ae86-d353c3069597"),
                            RoleInCompany = "Sellman",
                            Salary = 100000m
                        },
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2020, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(241), new TimeSpan(0, 2, 0, 0, 0)),
                            OfficeId = new Guid("d097a599-4619-4473-ae86-d353c3069597"),
                            RoleInCompany = "Sellman",
                            Salary = 240000m
                        },
                        new
                        {
                            ...
                            Hired = new DateTimeOffset(new DateTime(2020, 1, 24, 20, 32, 52, 296, DateTimeKind.Unspecified).AddTicks(244), new TimeSpan(0, 2, 0, 0, 0)),
                            OfficeId = new Guid("d097a599-4619-4473-ae86-d353c3069597"),
                            RoleInCompany = "Web developer",
                            Salary = 100000m
                        });
